...
do
	 ...
	 ./GetMI1D $GT 1 Gaus3D Gaus3D 30 0 >> n1$suff 
	 ./GetMI1D $GT 2 Gaus3D Gaus3D 30 0 >> n2$suff 
	 ./GetMI1D $GT 3 Gaus3D Gaus3D 30 0 >> n3$suff
	 ./GetNC $GT 0 Gaus3D Gaus3D 30     >> NC$suff
