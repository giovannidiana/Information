...
colpal=c(colpal_196[7], colpal_404[7], colpal_402[7], colpal_435[7]);
...
pos<-barplot(ttcomb_mod,space=c(.5,.1),
	     ...
	     cex.axis=2,
	     cex.lab=2,
	     col=cbind(colpal_196[c(7,4,5,6)],colpal_404[c(7,4,5,6)],colpal_402[c(7,4,5,6)],colpal_435[c(7,4,5,6)]));
